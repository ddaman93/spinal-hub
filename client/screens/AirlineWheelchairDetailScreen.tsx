...
import { getAirlineChairById } from "@/data/airlineWheelchairs";

type RouteProps = RouteProp<MainStackParamList, "AirlineWheelchairDetail">;

const AIRLINE_TYPE_LABELS: Record<string, string> = {
  "aisle-fixed":      "Aisle (Fixed)",
  "onboard-folding":  "Onboard (Folding)",
  "onboard-lift":     "Onboard Lift",
  "terminal-transit": "Terminal / Transit",
};

export default function AirlineWheelchairDetailScreen() {
  ...
  const chair = getAirlineChairById(params.productId);
    ...
    <ThemedView style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={styles.content}>
          ...
          >
            {AIRLINE_TYPE_LABELS[chair.airlineType] ?? chair.airlineType}
          </ThemedText>
